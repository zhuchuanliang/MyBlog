...
var calendar = function(calendarId){
    ...
    c.init = function(){
        ...
        loadStyles(".calendarDiv {width:350px;text-align:left;}\
            .Table{width:250px;height:200px;}\
            .box{margin-left:15px;margin-right:10px;text-align:center;width:230px;height:22px;font-weight:bold;font-size:21px;}\
