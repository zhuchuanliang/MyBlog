...
<div region="north" style="height: 78px;background-color: #ffffff">
	<table style="padding: 5px" width="100%">
		<tr>
			<td width="50%">
				<img alt="logo" src="/Blog/static/images/logo4.png">
			</td>
...
<div region="west" style="width: 200px" title="导航菜单" split="true">
	<div class="easyui-accordion" data-options="fit:true,border:false">
		...
		<div title="系统管理"  data-options="iconCls:'icon-system'" style="padding:10px">
			...
			<a href="javascript:openTab('密码修改','passwordModify.jsp','icon-link')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-modifyPassword'" style="width: 150px;">修改密码</a>
